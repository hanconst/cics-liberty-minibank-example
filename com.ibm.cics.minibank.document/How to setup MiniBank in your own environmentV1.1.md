...
1.  IBM Java SDK for z/OS  V7.0 for SR6 (or later)
...
1.  Repeat the 2~4 steps to add other three sessions: WTOA, ATOR, RTOA. Don’t forget to change the AUTOCONNECT to YES.
