...
<head>
    ...
    <title>IBM - MiniBank - Withdraw </title>
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div class="page-header">
              <h1 id="navbar"> Withdraw </h1>
            </div>

            <div class="bs-component">
              <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4> Transactions - Withdraw </h4>
                        </div>
                        <div class="panel-body">
                            <div class="row" style="margin-top: 40px">
                            		<div class="col-md-2"></div>
                            		<div class="col-md-8">
	                            		<form role="form" method="post" class="form-horizontal" action="doWithdraw">
	                                        ...
	                                        id="btn" style="margin-bottom:40px; margin-top: 30px" onclick="return onCheck()"> Withdraw </button>
	                                    </form>	
                                    </div>
  								    <div class="col-md-2"></div>
                            </div>
