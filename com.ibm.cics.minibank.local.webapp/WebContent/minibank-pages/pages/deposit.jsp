...
<head>
    ...
    <title>IBM - MiniBank - Deposit </title>
...
<div class="container">
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <div class="page-header">
              <h1 id="navbar"> Deposit </h1>
            </div>

            <div class="bs-component">
              <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4> Transaction - Deposit </h4>
                        </div>
                        <div class="panel-body">
                            <div class="row" style="margin-top: 40px">
                            		<div class="col-md-2"></div>
                            		<div class="col-md-8">
	                            		<form role="form" method="post" class="form-horizontal" action="doDeposit">
	                                        <div class="form-group has-success ">
	                                            ...
	                                            <div class="col-md-6">
											      ...
											      id="sourceAcct" placeholder=" Account ID ">
											    </div>
	                                        </div>
	                                        ...
	                                        id="btn" style="margin-bottom:40px; margin-top: 30px" onclick="return onCheck()"> Deposit </button>
	                                    </form>
                                    </div>
  								    <div class="col-md-2"></div>
                            </div>
    ...
    <script language='javascript'>
		...
		var amount=document.getElementById("amount").value;
 		...
 		var checkMessage=checkAccount(sourceAccount)+checkAmount(amount);
	 		if(checkMessage==""){
	 			return true;
	 		}
	 		else{
